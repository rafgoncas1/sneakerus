...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        ProductColor.objects.get_or_create(product=product4, color=color2)
        ...
        ProductColor.objects.get_or_create(product=product6, color=color2)
        ...
        ProductColor.objects.get_or_create(product=product7, color=color2)
        ...
        ProductColor.objects.get_or_create(product=product9, color=color2)
        ...
        ProductColor.objects.get_or_create(product=product10, color=color2)
